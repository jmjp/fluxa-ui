...
// src/panels/cartoes-main.tsx
function CartoesMain({ conversationId, context, onAction }) {
  const selected = context.selected_card;
  return /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("div", { className: "pcx" }, /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("style", null, PCX_CSS), /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("div", { className: "pcx-head" }, /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("h2", { className: "pcx-title" }, "Cart\xF5es do cliente")), /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("p", { className: "pcx-sub" }, "Conversa ", conversationId, " \xB7 selecione um cart\xE3o para inspecionar os dados."), /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("div", { className: "pcx-grid" }, DEMO_CARDS.map((card) => {
    const isSelected = selected === card.id;
    const select = () => onAction({ type: "context_update", updates: { selected_card: card.id } });
    return /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement(
      "article",
      {
        key: card.id,
      ...
      /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("div", { className: "pcx-card__top" }, /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("span", { className: "pcx-card__brand" }, BRAND_LABEL[card.brand]), /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("span", { className: `pcx-status pcx-status--${card.status}` }, card.status)),
      /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("div", { className: "pcx-chip" }),
      /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("div", { className: "pcx-card__num" }, masked(card.last4)),
      /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("div", { className: "pcx-card__bottom" }, /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("div", null, /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("span", { className: "pcx-lbl" }, "titular"), /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("span", { className: "pcx-val" }, card.holder)), /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("div", null, /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("span", { className: "pcx-lbl" }, "validade"), /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("span", { className: "pcx-val" }, card.expiry)), /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("div", { style: { textAlign: "right" } }, /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("span", { className: "pcx-lbl" }, "limite"), /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("span", { className: "pcx-val" }, fmtBRL(card.limit))))
    );
  })));
}

// src/panels/cartoes-sidebar.tsx
function CartoesSidebar({ context, onAction }) {
  ...
  return /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("div", { className: "pcx" }, /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("style", null, PCX_CSS), /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("div", { className: "pcx-detail" }, /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("h3", { className: "pcx-detail__title" }, "Dados do cart\xE3o"), /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("dl", { className: "pcx-rows" }, /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("div", { className: "pcx-row" }, /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("dt", null, "Bandeira"), /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("dd", null, BRAND_LABEL[card.brand])), /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("div", { className: "pcx-row" }, /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("dt", null, "N\xFAmero"), /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("dd", null, masked(card.last4))), /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("div", { className: "pcx-row" }, /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("dt", null, "Titular"), /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("dd", null, card.holder)), /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("div", { className: "pcx-row" }, /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("dt", null, "Validade"), /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("dd", null, card.expiry)), /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("div", { className: "pcx-row" }, /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("dt", null, "Limite"), /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("dd", null, fmtBRL(card.limit))), /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("div", { className: "pcx-row" }, /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("dt", null, "Fatura atual"), /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("dd", { className: card.invoice > 0 ? "pcx-neg" : "pcx-pos" }, fmtBRL(card.invoice))), /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("div", { className: "pcx-row" }, /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("dt", null, "Vencimento"), /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("dd", null, card.due)), /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("div", { className: "pcx-row" }, /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("dt", null, "Parcelas"), /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("dd", null, card.installments > 0 ? `${card.installments}x` : "\u2014"))), /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("div", { className: "pcx-actions" }, /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement(
    "button",
    {
      type: "button",
    ...
    "Registrar pagamento"
  ))), otherCtx.length > 0 && /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("div", { className: "pcx-context" }, /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("p", { className: "pcx-context__title" }, "Contexto acumulado"), /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("div", { className: "pcx-chips" }, otherCtx.map(([key, value]) => /* @__PURE__ */ globalThis.__FLUXA_REACT__.createElement("span", { key, className: "pcx-chipctx" }, key, "=", value)))));
}

// src/panels/index.ts
var index_default = [
  definePanel({ slot: "main", component: CartoesMain, displayName: "Cart\xF5es" }),
